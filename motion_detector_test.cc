...
#include "tensorflow/lite/micro/examples/motion_detector/slope_micro_features_data.h"
...
TF_LITE_MICRO_TEST(LoadModelAndPerformInference) {
  ...
  const tflite::Model* model = ::tflite::GetModel(g_motion_detector_model_data);
